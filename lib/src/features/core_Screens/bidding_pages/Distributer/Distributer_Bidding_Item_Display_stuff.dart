...
class Distributer_Bidding_Product_Display_page extends StatefulWidget {
  final String docId;
  ...
  const Distributer_Bidding_Product_Display_page(
      {super.key,
  ...
  @override
  State<Distributer_Bidding_Product_Display_page> createState() =>
      _Distributer_Bidding_Product_Display_pageState();
}

class _Distributer_Bidding_Product_Display_pageState
    extends State<Distributer_Bidding_Product_Display_page> {
  @override
