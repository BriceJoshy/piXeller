...
class Producer_Bid_Item_Add_page extends StatefulWidget {
  const Producer_Bid_Item_Add_page({super.key});

  @override
  State<Producer_Bid_Item_Add_page> createState() =>
      _Producer_Bid_Item_Add_pageState();
}

class _Producer_Bid_Item_Add_pageState
    extends State<Producer_Bid_Item_Add_page> {
  ...
  Future<void> addItemList() async {
    ...
    final newItemAdded = BidAddItemListModel(
        id: APIs.user.uid,
        itemCategory: ItemDropdownvalue,
        itemName: _itemNameController.text.trim(),
        itemQuantity: _quantityController.text.trim(),
        itemPrice: int.parse(_priceController.text.trim()),
