...
import 'Producer_bid_AddItem.dart';

class Producer_bidding_page extends StatefulWidget {
  const Producer_bidding_page({Key? key}) : super(key: key);

  @override
  _Producer_bidding_pageState createState() => _Producer_bidding_pageState();
}
...
class _Producer_bidding_pageState extends State<Producer_bidding_page> {
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (ItemName.toString().toLowerCase().contains(
                                ...
                                return Card(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      Get.to(() => producer_Bid_Item_Edit_page(
  ...
  Widget _buildNotchedButton() {
    return SizedBox(
      ...
      child: FloatingActionButton(
        onPressed: () {
          Get.to(
            () => const Producer_Bid_Item_Add_page(),
          );
        },
        backgroundColor: Colors.white,
        child: const Icon(
