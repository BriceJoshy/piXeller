...
class producer_Bid_Item_Edit_page extends StatefulWidget {
  final String docId;
  ...
  const producer_Bid_Item_Edit_page(
      {super.key,
  ...
  @override
  State<producer_Bid_Item_Edit_page> createState() =>
      _producer_Bid_Item_Edit_pageState();
}

class _producer_Bid_Item_Edit_pageState
    extends State<producer_Bid_Item_Edit_page> {
  ...
  Future<void> updateProductPicture(File file) async {
    ...
    final ref =
        APIs.storage.ref().child('bid_product_pictures/${widget.docId}.');
    index++;
    ...
    log(UrlImage + "::Image URL");
    await APIs.firestore.collection('Bid Item List').doc(widget.docId).update({
      'image': UrlImage,
