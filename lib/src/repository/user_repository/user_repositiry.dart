...
//   // we need to convert the AppUser to map of string and dybamic
//   // that means to convert to jso
//   // Step 1 - Store User in Firebase
//   createUser(AppUser user) async {
...
//   //  for single record
//   Future<AppUser> getUserDetails(String email) async {
//     final snapshot =
...
//     final userData = snapshot.docs.map((e) => AppUser.fromSnapshot(e)).single;
//     return userData;
//   }
...
//   //   // then we need to map the data to convert it to document snapshot then to list or to single records
//   //   final userData =
//   //       snapshot.docs.map((e) => AppUser.fromSnapshot(e)).toList();
//   //   return userData;
//   // }
